...
# things_on_screen contains everything that must be drawn by pygame, things_on_gui contains gui items, things_objects contains stuff
things_on_gui = [hp_container, mana_container, enemy_bar_container,square0,square1,square2,square3,square4,square5,hp_bar,mana_bar,enemy_bar,hp_text,mana_text,lh_text,rh_text,s1_text,s2_text,s3_text,s4_text,sun]
things_objects = [player_shadow, player, boss_shadow, boss]
things_on_screen = things_on_gui+things_objects
